...
restaurant2 = Restaurant.create(name: "KFC",    description: "Dirty", user_id: user2.id)
restaurant3 = Restaurant.create(name: "Wimpy",  description: "Filthy", user_id: user3.id)

Review.create(thoughts: "nasty" , rating: 1, restaurant_id: restaurant1.id)
Review.create(thoughts: "smelly", rating: 4, restaurant_id: restaurant2.id)
Review.create(thoughts: "wut"   , rating: 3, restaurant_id: restaurant3.id)
